...
export declare class RigidBody {
     ...
     * @param wakeUp - should the rigid-body be automatically woken-up?
     */
    applyTorque(torque: number, wakeUp: boolean): void;
    /**
...
export declare class RigidBodyDesc {
     ...
     */
    setMassProperties(mass: number, centerOfMass: Vector, principalAngularInertia: number): this;
    /**
     * Sets the mass properties of the rigid-body being built.
     *
     ...
     */
    setPrincipalAngularInertia(principalAngularInertia: number, collidersAngularInertiaContributionEnabled: boolean): this;
    /**
