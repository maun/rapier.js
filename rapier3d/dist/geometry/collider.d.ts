...
import { InteractionGroups, Cuboid, Ball, ShapeType, Capsule, Trimesh, Heightfield, Cylinder, RoundCylinder, Cone } from './index';
...
export declare class ColliderDesc {
    shape: Ball | Cuboid | Capsule | Trimesh | Heightfield | Cylinder | RoundCylinder | Cone;
    density?: number;
    friction: number;
    restitution: number;
    rotation: Rotation;
     ...
     */
    constructor(shape: Ball | Cuboid | Capsule | Trimesh | Heightfield | Cylinder | RoundCylinder | Cone);
    /**
     ...
     */
    static cylinder(half_height: number, radius: number): ColliderDesc;
    /**
     ...
     */
    static roundCylinder(half_height: number, radius: number, round_radius: number): ColliderDesc;
    /**
     ...
     */
    static cone(half_height: number, radius: number): ColliderDesc;
    /**
